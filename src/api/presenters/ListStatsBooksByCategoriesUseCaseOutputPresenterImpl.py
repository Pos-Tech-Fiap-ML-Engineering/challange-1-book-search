...
class ListStatsBooksByCategoriesUseCaseOutputPresenterImpl(
    BasePresenter, ListStatsBooksByCategoriesUseCaseOutputHandler
):
    def success(self, stats_books_by_categories: dict[str, BookStats]) -> None:
        ...
        self._set_result(JSONResponse(status_code=200, content=parsed_result))
