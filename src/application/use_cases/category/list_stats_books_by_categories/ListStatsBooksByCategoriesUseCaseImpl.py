...
class ListStatsBooksByCategoriesUseCaseImpl(
    ...
    input_type: type[ListStatsBooksByCategoriesUseCaseInput] = ListStatsBooksByCategoriesUseCaseInput

    def __init__(self, scrape_book_repository: ScrapeBookRepository) -> None:
        self._scrape_book_repository = scrape_book_repository

    async def execute_async(self, use_case_input: ListStatsBooksByCategoriesUseCaseInput,
                            use_case_output: ListStatsBooksByCategoriesUseCaseOutputHandler) -> None:
