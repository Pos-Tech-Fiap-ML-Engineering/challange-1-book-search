...
class ListTopRatedBooksUseCaseImpl(UseCase[ListTopRatedBooksUseCaseInput, ListTopRatedBooksUseCaseOutputHandler]):
    ...
    async def execute_async(self, use_case_input: ListTopRatedBooksUseCaseInput,
                            use_case_output: ListTopRatedBooksUseCaseOutputHandler) -> None:
