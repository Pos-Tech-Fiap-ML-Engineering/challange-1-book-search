...
class GetBookByIdUseCaseImpl(UseCase[GetBookByIdUseCaseInput, GetBookByIdUseCaseOutputHandler],
    ...
    async def execute_async(self, use_case_input: GetBookByIdUseCaseInput,
                            use_case_output: GetBookByIdUseCaseOutputHandler) -> None:
