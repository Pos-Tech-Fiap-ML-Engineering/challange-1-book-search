...
class AppLoggerImpl(AppLogger):
    ...
    @contextmanager
    def new_scope(self, scope_name: str, extra: Optional[Dict[str, str]] = None) -> Iterator[None]:
        ...
        merged_extra_attrs = {scope_name: scope_id, **(current_log_entry.extra_attrs or {}), **(extra or {}), }
    ...
    def _generate_log(self, level: int, message: str, extra: Optional[Dict[str, str]],
