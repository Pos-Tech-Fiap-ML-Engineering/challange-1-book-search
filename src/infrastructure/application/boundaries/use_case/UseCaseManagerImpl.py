...
class UseCaseManagerImpl(UseCaseManager):
    ...
    def _find_use_case(self, use_case_input: UseCaseInput, use_case_output_handler: UseCaseOutputHandler) -> UseCase:
    ...
    async def _is_invalid_input_async(self, use_case_input: UseCaseInput, use_case_output_handler: UseCaseOutputHandler,
                                      use_case: UseCase) -> bool:
    ...
    async def _handler_error_async(self, error: Exception, use_case_output: UseCaseOutputHandler) -> None:
